...
func main() {
    ...
    for {
        ...
        if matches == nil {
            fmt.Println("Напишите полноценное правильное выражение из римских или арабских цифр. Помните правила для «0»! \n")
            continue
        } 
        ...
        if a == "IIII" {
            fmt.Println("Пожалуйста, вводите правильные римские цифры. Четверка обозначается символами «IV». \n")
            continue
        }
        if b == "IIII" {
            fmt.Println("Пожалуйста, вводите правильные римские цифры. Четверка обозначается символами «IV». \n")
        ...
        func toArabic(s string) int {
            ...
            if err != nil || num < 1 || num > 10 {
                fmt.Println("Недопустимые арабские числа. Должно быть от 1 до 10.")
